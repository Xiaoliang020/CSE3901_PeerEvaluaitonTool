...
class StudentGroupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create student_group" do
    assert_difference('StudentGroup.count') do
      post student_groups_url, params: { student_group: { group_name: @student_group.group_name } }
    end
  ...
  test "should update student_group" do
    patch student_group_url(@student_group), params: { student_group: { group_name: @student_group.group_name } }
